...
export async function deliverSubmission(
  ...
  const { data, error } = await resend.batch.send([
    ...
    },
    {
      ...
      text: "Thanks for reaching out. I've received your message and will get back to you soon. Please do not reply to this email as it was generated from an email account that is not monitored.",
      tags: [
        { name: "submission_id", value: record._id },
        { name: "submission_type", value: record.type },
